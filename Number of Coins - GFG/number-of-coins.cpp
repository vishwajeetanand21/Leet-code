...
class Solution{
    ...
    // using memoization
    int usingMemoizationHelper(int currIndex, int*coins, int amount, vector<vector<int>>&dp)
    {
        // base case
        if(currIndex==0)
        {
    ...
    int usingMemoization(int currIndex, int*coins, int amount, int n)
    {
    ...
    // using recursion
    int usingRecursion(int currIndex, int*coins, int amount)
    {
        // base case
        if(currIndex==0)
        {
